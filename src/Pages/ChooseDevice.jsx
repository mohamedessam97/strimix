...
const Navigate = useNavigate()
  ...
  const setDeviceHandler = () => {
    ...
    if (userDevice) {
      ...
      Dispatch(
        AuthenticationSliceActions.setError("You have to select a device")
      );
    }
  };
    ...
    >
        ...
        <Grid item xs={12} sm={6} md={6}>
          ...
          >
            <Grid
              ...
              sx={{
                borderColor: tvchosen ? " #12C6B2 !important" : "",
                height: "200px",
                width: "200px",
              }}
              onClick={tvDeviceHandler}
            >
              <Stack
              ...
              >
                <LiveTvIcon
                  sx={{
                    width: "50px",
                    height: "50px",
                    color: tvchosen ? " #12C6B2" : "",
                  }}
                />
                <Typography
                  component="p"
                  color={tvchosen ? " #12C6B2 !important" : ""}
                  sx={{ fontSize: { lg: "16px", md: "16px" } }}
                >
                  TV
                </Typography>
                <Typography
            ...
            <Grid
              ...
              className={classes.device}
              sx={{
                borderColor: laptopchosen ? " #12C6B2 !important" : "",
                height: "200px",
                width: "200px",
              }}
              onClick={laptopDeviceHandler}
            >
              <Stack
                justifyContent="space-around"
                alignItems="center"
              ...
              >
                <LaptopMacIcon
                  sx={{
                    width: "50px",
                    height: "50px",
                    color: laptopchosen ? " #12C6B2 !important" : "",
                  }}
                />
                <Typography
                  component="p"
            ...
            <Grid
              ...
              className={classes.device}
              sx={{
                borderColor: mobilechosen ? " #12C6B2 !important" : "",
                height: "200px",
                width: "200px",
              }}
              onClick={mobileDeviceHandler}
            >
              <Stack
                justifyContent="space-around"
                alignItems="center"
              ...
              >
                <DevicesOtherIcon
                  sx={{
                    width: "50px",
                    height: "50px",
                    color: mobilechosen ? " #12C6B2 !important" : "",
                  }}
                />
                <Typography
                  component="p"
      ...
      >
        <LargeButton
          ...
          type="submit"
          size="large"
          onClick={setDeviceHandler}
          sx={{
            minWidth: { lg: "350px", md: "260px", sm: "150px", xs: "auto" },
        ...
        {requestError && (
          <Typography component="p" color="#f50057">
            {requestError}
          </Typography>
        )}
      </Stack>

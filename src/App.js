        ...
        <Suspense fallback={<Loader />}>
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route
                path="/home"
                element={isLoggedIn ? <HomeA /> : <NotFound />}
              />
              <Route
                path="/Movies"
                element={isLoggedIn ? <Movies /> : <NotFound />}
              />
              <Route
                path="/My%20List"
                element={isLoggedIn ? <MyList /> : <NotFound />}
              />
              <Route
                path="/Watched"
                element={isLoggedIn ? <Watched /> : <NotFound />}
              />
              <Route
                path="/watch/:id"
                element={isLoggedIn ? <Watch /> : <NotFound />}
              />
              <Route
                path="/account"
